...
\lstinputlisting[language=c++]{./source/02_Data Structures/11_LineContainer.cpp}
\subsection{Wavelet Tree}
\lstinputlisting[language=c++]{./source/02_Data Structures/12_Wavelet Tree.cpp}
...
\lstinputlisting[language=c++]{./source/06_Math/18_PollardRho.cpp}
\subsection{Division-Polynom}
\lstinputlisting[language=c++]{./source/06_Math/18_Division-Polynom.cpp}
\subsection{Primitive-Root}
\lstinputlisting[language=c++]{./source/06_Math/19_Primitive-Root.cpp}
\section{Strings}
...
\input{./source/08_OEIS/07_Arithmetic_Sequences.tex}
\subsection{Catalan}
\input{./source/08_OEIS/08_Catalan.tex}
\subsection{Centroid}
\input{./source/08_OEIS/09_Centroid_of_Polygon.tex}
\subsection{Derangement}
\input{./source/08_OEIS/10_Derangement.tex}
\subsection{Power}
\input{./source/08_OEIS/11_Power_Sum.tex}
\subsection{Stirling}
\input{./source/08_OEIS/12_Stirling_Number_of_the_Second_Kind.tex}
